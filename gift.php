...
<div style="height: 100%;" class="pimg6">


    <nav style="background: white; width: 100%;" class="navbar navbar-expand-lg navbar-light row">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li style="margin: 0 2rem;" class="nav-item">
                    <a class="nav-link" href="./index.php">GIFT <span class="sr-only">(current)</span></a>
                </li>
                <li style="margin: 0 2rem;" class="nav-item">
    ...
    <section style="margin-bottom: 2%;" class="row">
        ...
        <div style="width: 100%; margin:0;"  class="row">
            ...
            <div style="margin: 5%;" class="spacing-top-bottom col">
                <button style="padding: 4rem; width:80%; display: grid;" class="animate_btn_on_hover border trans how_it_works">
                ...
                <label style="padding: 2% 22% 2% 2%; margin: 0 auto; font-size: 26px;">Fill</label>
            </div>
            <!-- image 2 -->
            <div style="margin: 5%;" class="spacing-top-bottom col">
                <button style="padding: 4rem; width:80%; display: grid;" class="animate_btn_on_hover border trans how_it_works">
                ...
                <label style="padding: 2% 22% 2% 2%; margin: 0 auto; font-size: 26px;">Submit</label>
            </div>
            <!-- image 3 -->
            <div style="margin: 5%;" class="spacing-top-bottom col">
                <button style="padding: 4rem;width:80%; display: grid;" class="animate_btn_on_hover border trans how_it_works">
                ...
                <label style="padding: 2% 22% 2% 2%; margin: 0 auto; font-size: 26px;">Gift</label>
            </div>
        </div>
    ...
    <div class="form"  style="background-color: rgba(160, 28, 53, 1); color: white;">
        ...
        <form action="showGift.php" method="post">
            <div class="row text-justified">
                <div class="col-3"></div>
                <div class="col-6 form-group text-justified emailArea">
            ...
            <div class="row text-justified">
                <div class="col-3"></div>
                <div class="col-3 form-group text-justified attrArea_1">
                ...
                <div class="col-3 form-group text-justified subattrArea_1">
            ...
            <div class="row text-justified">
                <div class="col-3"></div>
                <div class="col-3 form-group text-justified attrArea_2">
                ...
                <div class="col-3 form-group text-justified subattrArea_2">
            ...
            <div class="row text-justified">
                <div class="col-3"></div>
                <div class="col-3 form-group text-justified attrArea_3">
                    <label for="Attribute_3">Pick the third attribute from below to describe your giftee</label> <br>
                ...
                <div class="col-3 form-group text-justified subattrArea_3">
            ...
            <div class="row text-center" style="padding:3% 0 2% 0;">
                ...
                <div class="col-8  text-center">
                    <button class="submit gift_button border" name="submit" type="submit" value="submit" style="color: white;">Find me a Gift</button>
                </div>
                <div class="col-2"></div>
            </div>
